...
namespace NeptuneEvo.Jobs
{
    class Miner : Script
    {
        ...
        #endregion
        #region Меню 'E'
        public static void StartWorkDayMiner(Client player)
        {
        ...
        public static void ClientEvent_Miner(Client client, int act)
        {
            try
            {
                switch (act)
            ...
            try
            {
                ...
                if (player.GetData("PACKAGES") == 0)
                {
                    if (shape.GetData("NUMBER2") == player.GetData("WORKCHECK"))
                    {
                        ...
                        else if (shape.GetData("NUMBER2") > 2 && shape.GetData("NUMBER2") < 6) // 3 4 5
                        {
                            ...
                            player.SetData("PAYMENT", player.GetData("PAYMENT") + payment2);
                            //Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter, $"Ваша зарплата составляет: {player.GetData("PAYMENT")}$", 1000);
                        }
                        else if (shape.GetData("NUMBER2") > 5)
                        { // 6 7 8
                            ...
                            player.SetData("PAYMENT", player.GetData("PAYMENT") + payment3);
                            //Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter, $"Ваша зарплата составляет: {player.GetData("PAYMENT")}$", 1000);
                        }
