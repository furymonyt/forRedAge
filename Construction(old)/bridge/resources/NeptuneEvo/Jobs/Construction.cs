...
namespace NeptuneEvo.Jobs
{
    class Construction : Script
    {
        ...
        public static void StartWorkDayConstruction(Client player)
        {
        ...
        public static void ClientEvent_Construction(Client client, int act)
        {
            try
            {
                switch (act)
